...
const App = () => {
  ...
  const HomeView = () => (
    <div className="animate-in fade-in duration-1000 text-left">
          ...
          <div className="max-w-4xl text-left">
            ...
            <div className="relative max-w-4xl z-20 text-left">
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-2 md:p-3 rounded-[2rem] flex flex-col md:flex-row items-center gap-2 shadow-2xl text-left">
                ...
                <button onClick={() => navigateTo('search')} className="bg-[#AF9042] text-white p-4 rounded-full hover:bg-white hover:text-[#0A1929] transition-all transform hover:scale-105 shadow-xl text-left">
      ...
      <section className="py-32 bg-white text-center text-left text-left">
        <div className="container mx-auto px-10 text-left text-left text-left text-left text-left">
          <div className="flex flex-col items-center text-center mb-24 text-center text-center">
            ...
            <p className="text-[#0A1929]/60 font-light max-w-lg text-[13px] leading-relaxed uppercase tracking-wider italic text-center text-left">Confira os imóveis selecionados</p>
          </div>
      ...
      <section className="py-32 bg-white border-t border-gray-50 text-center">
        <div className="container mx-auto px-10">
          <div className="flex flex-col items-center text-center mb-16 text-center text-center text-center"><h2 className="text-3xl font-extralight text-[#0A1929] uppercase tracking-[0.4em] mb-4 text-center">Explore por bairros</h2><Minus className="text-[#AF9042] text-center" /></div>
          <div className="relative group text-left">
            <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-4 h-[600px] animate-in fade-in duration-700 text-left text-left text-left">
              {NEIGHBORHOOD_PAGES[neighborhoodPage].map((b) => (
                <div key={b.id} className={`relative group overflow-hidden rounded-sm cursor-pointer shadow-lg text-left ${b.size === 'large' ? 'md:col-span-2 md:row-span-2' : b.size === 'medium' ? 'md:col-span-2 md:row-span-1' : 'md:col-span-1 md:row-span-1'}`}>
                  ...
                  <div className="absolute inset-0 bg-black/20 flex flex-col justify-end p-8 text-left text-left text-left text-left text-left"><span className="text-[#AF9042] text-[10px] font-light uppercase tracking-[0.4em] text-left">Explorar</span><h3 className="text-white text-3xl font-extralight tracking-widest uppercase text-left">{b.name}</h3></div>
                </div>
              ))}
            </div>
            <div className="absolute top-1/2 -left-6 -translate-y-1/2 z-10 text-left text-left"><button onClick={() => setNeighborhoodPage(0)} className={`p-4 bg-white shadow-xl rounded-full transition-all text-left text-left ${neighborhoodPage === 0 ? 'opacity-20' : 'hover:scale-110'}`} disabled={neighborhoodPage === 0}><ChevronLeft size={20} className="text-[#AF9042]" /></button></div>
            <div className="absolute top-1/2 -right-6 -translate-y-1/2 z-10 text-left text-left text-left text-left"><button onClick={() => setNeighborhoodPage(1)} className={`p-4 bg-white shadow-xl rounded-full transition-all text-left text-left ${neighborhoodPage === 1 ? 'opacity-20' : 'hover:scale-110'}`} disabled={neighborhoodPage === 1}><ChevronRight size={20} className="text-[#AF9042]" /></button></div>
          </div>
        </div>
      </section>

      {/* HIGHLIGHTS RAVA ANTES DO RODAPÉ (RECUPERADO) */}
      <section className="py-24 bg-[#0A1929] text-white">
        <div className="container mx-auto px-10 grid grid-cols-1 md:grid-cols-3 gap-16 text-center text-left text-left text-left">
          {[
        ...
        <div className="container mx-auto px-10 lg:px-20 text-left">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start mb-16 gap-8 text-left text-left text-left">
            <div className="flex flex-col max-w-2xl text-left text-left">
              <div className="flex items-center gap-3 mb-6 text-left text-left text-left text-left">
                <span className="text-[#AF9042] text-[9px] font-light uppercase tracking-[0.4em] border-b border-[#AF9042] pb-1 text-left text-left text-left">Ref: {property.id}</span>
                <span className="text-[#0A1929]/30 text-[9px] font-light uppercase tracking-[0.4em] italic text-left text-left text-left text-left text-left">Curadoria Rava Imóveis</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-extralight text-[#0A1929] mb-4 leading-tight tracking-tight text-left italic text-left text-left text-left text-left">{property.title}</h1>
              <p className="flex items-center gap-2 text-[#0A1929]/50 font-light text-[13px] tracking-widest uppercase text-left text-left text-left text-left text-left text-left">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-start text-left text-left text-left">
            ...
            <div className="lg:col-span-8 text-left text-left text-left text-left text-left">
              <div className="mb-12 group relative overflow-hidden rounded-sm shadow-xl text-left text-left text-left text-left text-left">
                 <img src={property.image} className="w-full h-[650px] object-cover transition-all duration-[3s] group-hover:scale-105 text-left text-left text-left text-left text-left" alt={property.title} />
                 <div className="absolute bottom-10 left-10 flex gap-4 text-left">
                   ...
                   <button className="bg-white/90 backdrop-blur-md px-10 py-4 text-[10px] font-light uppercase tracking-[0.3em] text-[#0A1929] hover:bg-[#0A1929] hover:text-white transition-all shadow-2xl flex items-center gap-3 border border-white/50 text-left text-left text-left text-left text-left"><Play size={14} className="text-[#AF9042]" /> Vídeo</button>
                 </div>
              </div>

              <div className="grid grid-cols-2 md:grid-cols-4 gap-12 border-y border-gray-100 py-16 mb-20 text-left text-left text-left text-left text-left text-left">
                 <div className="flex flex-col gap-3 items-center text-center text-center text-center text-center text-center"><Square size={20} strokeWidth={1} className="text-[#AF9042]" /><span className="text-[9px] uppercase tracking-[0.3em] text-[#0A1929]/40 font-bold text-center text-center text-center text-center">Área Útil</span><span className="text-2xl font-light text-[#0A1929] text-center text-center text-center text-center text-center">{property.area} m²</span></div>
                 <div className="flex flex-col gap-3 items-center text-center text-center text-center text-center text-center text-center text-center text-center"><BedDouble size={20} strokeWidth={1} className="text-[#AF9042]" /><span className="text-[9px] uppercase tracking-[0.3em] text-[#0A1929]/40 font-bold text-center text-center text-center text-center text-center">Suítes</span><span className="text-2xl font-light text-[#0A1929] text-center text-center text-center text-center text-center text-center text-center">{property.suites}</span></div>
                 <div className="flex flex-col gap-3 items-center text-center text-center text-center text-center text-center text-center text-center text-center text-center text-center"><Bath size={20} strokeWidth={1} className="text-[#AF9042]" /><span className="text-[9px] uppercase tracking-[0.3em] text-[#0A1929]/40 font-bold text-center text-center text-center text-center text-center text-center">Banheiros</span><span className="text-2xl font-light text-[#0A1929] text-center text-center text-center text-center text-center text-center text-center text-center">{property.baths}</span></div>
                 <div className="flex flex-col gap-3 items-center text-center text-center text-center text-center text-center text-center text-center text-center text-center text-center text-center text-center"><Car size={20} strokeWidth={1} className="text-[#AF9042]" /><span className="text-[9px] uppercase tracking-[0.3em] text-[#0A1929]/40 font-bold text-center text-center text-center text-center text-center text-center text-center">Vagas</span><span className="text-2xl font-light text-[#0A1929] text-center text-center text-center text-center text-center text-center text-center text-center">{property.parking}</span></div>
              </div>

              <div className="mb-24 text-left text-left text-left text-left text-left text-left text-left">
                <div className="flex items-center gap-6 mb-10 text-left text-left text-left text-left text-left text-left text-left text-left"><Minus className="text-[#AF9042] text-left text-left" /><h3 className="text-xl font-extralight text-[#0A1929] uppercase tracking-[0.4em] text-left text-left text-left text-left">O Imóvel</h3></div>
                <p className="text-[#0A1929]/60 font-light text-[15px] leading-loose italic max-w-3xl mb-16 border-l border-[#AF9042]/20 pl-8 text-left italic text-left text-left text-left text-left text-left">"{property.description}"</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-20 mb-20 text-left text-left text-left text-left text-left">
                  {property.features?.map(f => (<div key={f} className="flex items-center gap-4 text-[11px] font-light text-[#0A1929] border-b border-gray-50 pb-4 uppercase tracking-widest text-left text-left text-left text-left text-left text-left text-left"><CheckCircle2 size={14} strokeWidth={1} className="text-[#AF9042]" /> {f}</div>))}
                </div>

                <div className="flex items-center gap-6 mb-10 text-left text-left text-left text-left text-left text-left text-left text-left text-left"><Minus className="text-[#AF9042] text-left text-left" /><h3 className="text-xl font-extralight text-[#0A1929] uppercase tracking-[0.4em] text-left text-left text-left text-left text-left text-left">Infraestrutura do Prédio</h3></div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-20 mb-20 p-10 bg-slate-50/50 rounded-sm text-left text-left text-left text-left text-left">
                  {property.amenities?.map(a => (
                    <div key={a} className="flex items-center gap-4 text-[11px] font-light text-[#0A1929] uppercase tracking-widest text-left text-left text-left text-left text-left text-left text-left text-left text-left">
                      <ShieldCheck size={14} strokeWidth={1} className="text-[#AF9042]" /> {a}
                    </div>
                  ))}
                </div>

                <div className="flex items-center gap-6 mb-10 text-left text-left text-left text-left text-left text-left text-left text-left text-left"><Minus className="text-[#AF9042] text-left text-left" /><h3 className="text-xl font-extralight text-[#0A1929] uppercase tracking-[0.4em] text-left text-left text-left text-left text-left text-left text-left">Diferenciais & Facilidades</h3></div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24 text-left text-left text-left text-left text-left text-left">
                  {property.conveniences?.map((item) => (
                    <div key={item.id} className="flex items-center gap-6 p-8 border border-gray-100 rounded-sm hover:border-[#AF9042] transition-colors group text-left text-left text-left text-left text-left text-left">
                       <div className="text-[#AF9042] group-hover:scale-110 transition-transform text-left text-left text-left text-left text-left text-left text-left text-left">{item.icon}</div>
                       <div className="text-left text-left text-left text-left text-left text-left">
                         <p className="text-[10px] font-bold uppercase tracking-widest text-[#0A1929] text-left text-left text-left text-left text-left"> {item.label}</p>
                         <p className="text-[11px] font-light text-[#0A1929]/60 italic text-left text-left text-left text-left text-left text-left">{item.desc}</p>
                       </div>
                    </div>
                  ))}
                  <div className="flex items-center gap-6 p-8 border border-gray-100 rounded-sm group text-left text-left text-left text-left text-left text-left">
                     <Dog size={24} className="text-[#AF9042] group-hover:scale-110 transition-transform text-left text-left text-left text-left text-left text-left" />
                     <div className="text-left text-left text-left text-left text-left text-left text-left">
                       <p className="text-[10px] font-bold uppercase tracking-widest text-[#0A1929] text-left text-left text-left text-left text-left text-left">Pet Friendly</p>
                       <p className="text-[11px] font-light text-[#0A1929]/60 italic text-left text-left text-left text-left text-left text-left text-left">{property.petPolicy}</p>
                     </div>
                  </div>
                </div>

                <div className="flex items-center gap-6 mb-10 text-left text-left text-left text-left text-left text-left text-left text-left text-left"><Minus className="text-[#AF9042] text-left text-left" /><h3 className="text-xl font-extralight text-[#0A1929] uppercase tracking-[0.4em] text-left text-left text-left text-left text-left text-left text-left text-left">Vida no Entorno</h3></div>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-24 text-center text-center text-center text-center text-center text-center text-center text-center text-center">
                  {[{icon:<Coffee size={24}/>,label:"Padarias"},{icon:<PlusSquare size={24}/>,label:"Farmácias"},{icon:<Fuel size={24}/>,label:"Postos"},{icon:<ShoppingBag size={24}/>,label:"Mercados"}].map((item, idx) => (
                    <div key={idx} className="flex flex-col items-center gap-4 p-8 border border-gray-100 rounded-sm hover:border-[#AF9042] transition-colors group text-center text-center text-center text-center text-center text-center text-center text-center">
                       <div className="text-[#AF9042] group-hover:scale-110 transition-transform text-center">{item.icon}</div>
                       <span className="text-[10px] font-light uppercase tracking-widest text-[#0A1929] text-center text-center text-center text-center text-center text-center">{item.label}</span>
                    </div>
                  ))}
                </div>

                <div className="h-[450px] bg-slate-100 rounded-sm relative overflow-hidden grayscale hover:grayscale-0 transition-all duration-[3s] text-left text-left text-left text-left text-left text-left text-left text-left">
                   <img src="https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&w=1200&q=80" className="w-full h-full object-cover opacity-30 text-left text-left text-left text-left text-left text-left text-left text-left text-left" alt="Mapa" />
                   <div className="absolute inset-0 flex items-center justify-center text-left text-left text-left text-left text-left text-left text-left text-left">
                     <div className="bg-white p-6 shadow-2xl rounded-sm flex flex-col items-center text-left text-left text-left text-left text-left text-left text-left text-left">
                       <MapPin size={32} className="text-[#AF9042] mb-2 animate-bounce" />
                       <p className="text-[11px] font-light uppercase tracking-widest text-[#0A1929] text-left text-left text-left">{property.neighborhood}</p>
                     </div>
                   </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-4 self-start sticky top-32 text-left text-left text-left text-left text-left text-left">
              <div className="space-y-8 pb-20 text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left">
                <div className="p-10 border border-gray-100 rounded-sm bg-[#FCFCFC] shadow-sm text-left text-left text-left text-left text-left text-left text-left text-left text-left">
                   <span className="text-[10px] font-light uppercase tracking-[0.4em] text-[#AF9042] mb-2 block italic text-left text-left text-left text-left text-left text-left text-left text-left">
                   ...
                   <div className="flex flex-col gap-2 text-[11px] font-light text-[#0A1929]/50 uppercase tracking-[0.1em] border-t border-gray-100 pt-6 text-left text-left text-left text-left text-left text-left text-left text-left text-left">
                      ...
                      <div className="flex justify-between text-left text-left text-left text-left"><span>Condomínio</span> <span>{formatCurrency(property.condo)}</span></div>
                      <div className="flex justify-between text-left text-left text-left text-left text-left"><span>IPTU Mensal</span> <span>{formatCurrency(property.iptu)}</span></div>
                   </div>
                </div>
                <div className="bg-[#0A1929] p-12 rounded-sm shadow-2xl relative overflow-hidden text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left">
                  <span className="text-[#AF9042] text-[9px] font-light uppercase tracking-[0.5em] block mb-10 underline underline-offset-[12px] text-left text-left text-left text-left text-left text-left text-left text-left text-left">Atendimento Privativo</span>
                  <div className="space-y-6 mb-12 text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left">
                    <button onClick={openWhatsApp} className="w-full bg-[#AF9042] text-white py-6 text-[10px] font-light uppercase tracking-[0.3em] hover:bg-white hover:text-[#0A1929] transition-all flex items-center justify-center gap-3 shadow-xl border border-[#AF9042] text-left text-left text-left text-left text-left text-left text-left"><Phone size={16} strokeWidth={1} className="text-white" /> WhatsApp Concierge</button>
                    <button className="w-full border border-white/20 text-white py-6 text-[10px] font-light uppercase tracking-[0.3em] hover:bg-white/10 transition-all flex items-center justify-center gap-3 text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left"><Calendar size={16} strokeWidth={1} className="text-[#AF9042]" /> Agendar Visita VIP</button>
                  </div>
                  <div className="pt-10 border-t border-white/10 flex items-center gap-6 text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left"><div className="w-14 h-14 rounded-full bg-white/5 flex items-center justify-center border border-white/10 grayscale opacity-40 text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left"><ShieldCheck size={24} className="text-[#AF9042]" strokeWidth={1} /></div><div className="text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left"><p className="text-[10px] font-light uppercase tracking-widest text-[#AF9042] mb-1 text-left text-left text-left text-left text-left text-left text-left text-left text-left">Especialista Rava</p><p className="text-[11px] font-light text-white/50 italic tracking-wide italic text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left">Consultoria Bilíngue 24/7</p></div></div>
                </div>
              </div>
            </div>
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-[#0A1929] selection:bg-[#AF9042] selection:text-white antialiased text-left text-left text-left text-left text-left text-left text-left text-left text-left">
      <Navbar />
      {mobileMenu && (
        <div className="fixed inset-0 z-[110] bg-[#0A1929] flex flex-col items-center justify-center gap-12 text-white text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left"><button onClick={() => setMobileMenu(false)} className="absolute top-10 right-10 text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left"><X size={32} strokeWidth={1} className="text-[#AF9042]"/></button>{['home', 'search', 'b2b', 'about'].map(v => (<button key={v} onClick={() => navigateTo(v)} className="text-2xl font-extralight uppercase tracking-[0.5em] text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left">{v === 'home' ? 'RAVA' : v}</button>))}</div>
      )}
      <main className="text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left">
        {view === 'home' && <HomeView />}
        {view === 'search' && <div className="pt-32 pb-24 text-center text-[10px] uppercase tracking-widest text-[#0A1929]/40 italic text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left text-left">Resultados da Busca (Em Construção)</div>}
